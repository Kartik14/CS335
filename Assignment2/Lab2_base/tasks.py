...
def taskSquare(draw):
	...
	nn1 = nn.NeuralNetwork(2, 0.1, 10, 25)
...
def taskSemiCircle(draw):
	...
	nn1 = nn.NeuralNetwork(2,0.1,10,20)
...
def taskCifar10():	
	...
	nn1 = nn.NeuralNetwork(10,0.1,8,12)
	nn1.addLayer(ConvolutionLayer([3,32,32], [16,16], 8, 2))
	nn1.addLayer(AvgPoolingLayer([8,9,9], [3,3], 3))
	nn1.addLayer(FlattenLayer())
	nn1.addLayer(FullyConnectedLayer(72,10))
